const CACHE_NAME = 'cybernexo-prisma-pwa-v18';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './icon.svg',
  './styles/app.css',
  './styles/training-sprite-overrides.css',
  './src/main.js',
  './src/pwa.js',
  ...
  './assets/evolutions/training/phase-1-training-animated.svg',
  './assets/evolutions/training/phase-1-training-sprites.svg'
];
